...
} satisfies Record<CapabilityVariant, React.ComponentType<LucideProps>>;
...
/** Owner contract for the two-tone highlight behind a capability icon. */
export interface CapabilityTone {
  soft: string;
  strong: string;
}
