...
interface NexGEmptyStateProps {
  /** Decorative content emoji (merchant/item imagery). Prefer `icon` for chrome. */
  emoji?: string;
  /** Chrome icon — Ionicons glyph rendered instead of emoji when provided. */
...
export const NexGEmptyState = ({ emoji, icon, title, message, actionLabel, onAction }: NexGEmptyStateProps) => {
