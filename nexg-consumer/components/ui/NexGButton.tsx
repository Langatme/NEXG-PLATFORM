...
interface NexGButtonProps {
  ...
  loading?: boolean;
  disabled?: boolean;
  /** Decorative content emoji (e.g. merchant-provided). Prefer `ionIcon` for chrome. */
  icon?: string;
  /** Chrome icon — Ionicons glyph rendered before the label. */
      ...
      <Animated.View
        ...
        {loading ? (
          ...
          <>
            ...
            {ionIcon ? <Ionicons name={ionIcon} size={18} color={textColor} style={{ marginRight: 6 }} /> : null}
